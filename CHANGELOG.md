...
## [0.37.0](https://github.com/ConnectionMaster/corepack/compare/v0.36.0...v0.37.0) (2026-09-11)
...
* add `COREPACK_ON_UNVERIFIED_DOWNLOAD` env variable ([#856](https://github.com/ConnectionMaster/corepack/issues/856)) ([0125d89](https://github.com/ConnectionMaster/corepack/commit/0125d89ac904672bb42bc48bb6612d137beeccda))
...
* add support for tags and ranges in `prepare` command ([#136](https://github.com/ConnectionMaster/corepack/issues/136)) ([29da06c](https://github.com/ConnectionMaster/corepack/commit/29da06c515e917829e5ffbedb34284a6597e9d56))
...
* fall back to package-root metadata when dist.signatures is missing on the version endpoint ([#870](https://github.com/ConnectionMaster/corepack/issues/870)) ([b26c9d5](https://github.com/ConnectionMaster/corepack/commit/b26c9d52fdbc5db326e631de3f6557f7e1b7e55d))
* only load closest env file, for every commands ([#891](https://github.com/ConnectionMaster/corepack/issues/891)) ([b856c51](https://github.com/ConnectionMaster/corepack/commit/b856c516c3d0a92ded6b3f9cbbaa0d3f3eb094f1))
...
* update package manager versions ([#184](https://github.com/ConnectionMaster/corepack/issues/184)) ([84ae313](https://github.com/ConnectionMaster/corepack/commit/84ae3139e4b9a86d97465e36b50beb9201fda732))
...
* update package manager versions ([#425](https://github.com/ConnectionMaster/corepack/issues/425)) ([1423190](https://github.com/ConnectionMaster/corepack/commit/142319056424b1e0da2bdbe801c52c5910023707))
...
* update package manager versions ([#820](https://github.com/ConnectionMaster/corepack/issues/820)) ([fdbd751](https://github.com/ConnectionMaster/corepack/commit/fdbd751d9851a50730925de053e9722963c2e135))
* update package manager versions ([#852](https://github.com/ConnectionMaster/corepack/issues/852)) ([7e613b8](https://github.com/ConnectionMaster/corepack/commit/7e613b84b079411cb9eab1f90b254597fb9ef70c))
...
* use range from `devEngines` when no `packageManager` is set ([#892](https://github.com/ConnectionMaster/corepack/issues/892)) ([dec830b](https://github.com/ConnectionMaster/corepack/commit/dec830b035f540d1b4ebc516e81fbf43c5e0ffcf))
...
* bump package manager versions ([#754](https://github.com/ConnectionMaster/corepack/issues/754)) ([35e3869](https://github.com/ConnectionMaster/corepack/commit/35e3869f3f4d21bbfccdf78ea564ab0723d6f36f))
* bump pnpm version in `config.json` ([#768](https://github.com/ConnectionMaster/corepack/issues/768)) ([99a9a6e](https://github.com/ConnectionMaster/corepack/commit/99a9a6eb1b6e918ceb896b3d558bb5ed583bdc70))
* call `executePackageManagerRequest` directly ([#430](https://github.com/ConnectionMaster/corepack/issues/430)) ([0f9b748](https://github.com/ConnectionMaster/corepack/commit/0f9b74864048d5dc150a63cc582966af0c5f363f))
...
* **docs:** fix PowerShell functions suggestions ([#784](https://github.com/ConnectionMaster/corepack/issues/784)) ([b1544c8](https://github.com/ConnectionMaster/corepack/commit/b1544c82a63781bd77d49f7b566fefd0104b7d6d))
...
* hash check when downloading Yarn Berry from npm ([#439](https://github.com/ConnectionMaster/corepack/issues/439)) ([4672162](https://github.com/ConnectionMaster/corepack/commit/467216281e1719a739d0eeea370b335adfb37b8d))
...
* ignore devEngines version range when CLI provides a version ([#762](https://github.com/ConnectionMaster/corepack/issues/762)) ([ac518c4](https://github.com/ConnectionMaster/corepack/commit/ac518c4106f8d9ceb4e85e6c3614b1eba5d03fcb))
...
* incorrect registry origin check ([#743](https://github.com/ConnectionMaster/corepack/issues/743)) ([cc840b2](https://github.com/ConnectionMaster/corepack/commit/cc840b2d232a29c225d2436d350640f0035ed28b))
...
* **npmRegistryUtils:** env vars names in integrity check fail error message ([#854](https://github.com/ConnectionMaster/corepack/issues/854)) ([8ca01c3](https://github.com/ConnectionMaster/corepack/commit/8ca01c3fbeed6c8b5d1bb94df1aacb3fe6cff846))
...
* **pnpm:** fix bin path for v11 ([#776](https://github.com/ConnectionMaster/corepack/issues/776)) ([0c8048a](https://github.com/ConnectionMaster/corepack/commit/0c8048adc61651f6eb798448675d3ecc4a7e26a9))
...
* strip trailing slashes from COREPACK_NPM_REGISTRY ([#871](https://github.com/ConnectionMaster/corepack/issues/871)) ([b81e92c](https://github.com/ConnectionMaster/corepack/commit/b81e92c2338ed6c4c38cfe1239002a261e47e6d5))
* target node 22.22.2 in esbuild ([#845](https://github.com/ConnectionMaster/corepack/issues/845)) ([0f01502](https://github.com/ConnectionMaster/corepack/commit/0f01502fd8832649a573bc68e1851128f547646d))
...
* update package manager versions ([#728](https://github.com/ConnectionMaster/corepack/issues/728)) ([78ce029](https://github.com/ConnectionMaster/corepack/commit/78ce0297a9152bb5c68f724821a9a0095b408334))
* update package manager versions ([#765](https://github.com/ConnectionMaster/corepack/issues/765)) ([13a2e98](https://github.com/ConnectionMaster/corepack/commit/13a2e989ee37694a7ec1b1d60acdaa28f90642d1))
* update package manager versions ([#773](https://github.com/ConnectionMaster/corepack/issues/773)) ([06c286b](https://github.com/ConnectionMaster/corepack/commit/06c286b5fc171e43090b5eed5cd501bc9580927f))
* update package manager versions ([#778](https://github.com/ConnectionMaster/corepack/issues/778)) ([efed597](https://github.com/ConnectionMaster/corepack/commit/efed59797d30caa362a1fa8475cd7d17dc3b7282))
* update package manager versions ([#790](https://github.com/ConnectionMaster/corepack/issues/790)) ([e8961d6](https://github.com/ConnectionMaster/corepack/commit/e8961d6bdc14b8141fbda008febdd3649022862c))
* use `lstatSync` in `generatePosixLink` ([#767](https://github.com/ConnectionMaster/corepack/issues/767)) ([a02bea0](https://github.com/ConnectionMaster/corepack/commit/a02bea078eb584ed7492ec561626987e35386bae))
...
* Yarn switch install support and tests ([#761](https://github.com/ConnectionMaster/corepack/issues/761)) ([d04d483](https://github.com/ConnectionMaster/corepack/commit/d04d4839aeecaf4fca989c577f6c000dc90be933))
...
* **deps:** bump engine support matrix ([88c602a](https://github.com/ConnectionMaster/corepack/commit/88c602a6ea3f75bf30dc1d071bdb488fae2c8276))
* **deps:** bump engine support matrix ([#831](https://github.com/ConnectionMaster/corepack/issues/831)) ([c344b88](https://github.com/ConnectionMaster/corepack/commit/c344b887f4b710edbcb9575b72e858d04d57999f))
* **deps:** drop Undici and `proxy-from-env` ([8167b0d](https://github.com/ConnectionMaster/corepack/commit/8167b0d65acc091af464ead019f7485cb512082f))
